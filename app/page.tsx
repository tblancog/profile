      ...
      <main className="flex flex-col min-h-screen w-full max-w-[1440px] mx-auto">
        ...
        >
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 w-full lg:max-w-[1200px]">
            ...
            <Reveal
              delay={0.1}
              className="flex flex-col gap-6 w-full lg:flex-1"
            >
              ...
              <p className="hidden lg:block text-[var(--text-secondary)] font-inter text-base font-normal leading-[1.7] text-left w-full">
                ...
                I&apos;m equally at home architecting backends, leading frontend
                teams, or shipping mobile apps with React Native. I&apos;ve
                deployed across AWS, GCP, and Azure DevOps, actively integrate
                AI tooling (Claude, OpenAI, AWS Bedrock) into my workflow, and
                own full delivery cycles from architecture through production.
              </p>
            </Reveal>
          ...
          <Reveal>
            <div className="flex flex-col items-center gap-3 lg:gap-4 w-full">
              ...
              <p className="text-[var(--text-secondary)] font-inter text-[13px] lg:text-lg font-normal text-center w-full">
                Based in Argentina with significant overlapping hours with US
                time zones
              </p>
            </div>
          </Reveal>
          ...
          >
            ...
            >
              <CardBody className="flex flex-col items-center gap-3 lg:gap-4 p-5 lg:p-8">
                ...
                <p className="text-[var(--text-secondary)] font-inter text-[13px] lg:text-[15px] font-normal leading-[1.5] lg:leading-[1.6] text-center w-full">
                  4-6 hours of overlap with US Eastern time. When it&apos;s 2-4
                  PM in Argentina, it&apos;s 9 AM-12 PM in New York.
                </p>
              </CardBody>
            </Card>
            ...
            >
              <CardBody className="flex flex-col items-center gap-3 lg:gap-4 p-5 lg:p-8">
                ...
                <p className="text-[var(--text-secondary)] font-inter text-[13px] lg:text-[15px] font-normal leading-[1.5] lg:leading-[1.6] text-center w-full">
                  No waiting overnight for responses. Direct collaboration
                  during your business hours for faster decisions and project
                  velocity.
                </p>
              </CardBody>
            </Card>
            ...
            >
              <CardBody className="flex flex-col items-center gap-3 lg:gap-4 p-5 lg:p-8">
                ...
                <p className="text-[var(--text-secondary)] font-inter text-[13px] lg:text-[15px] font-normal leading-[1.5] lg:leading-[1.6] text-center w-full">
                  Same-day iterations and quick feedback loops. No off-hours
                  work required from either party.
                </p>
              </CardBody>
            </Card>
          </Reveal>
